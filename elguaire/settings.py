...
if DEBUG:
    with open('elguaire/elguaire.config.json') as config_file:
        config = json.load(config_file)

    ALLOWED_HOSTS = ['*']

else:
    with open('/etc/cta.config.json') as config_file:
        config = json.load(config_file)
    ...
    SESSION_COOKIE_AGE = 7200  # duración de la session
    SESSION_SAVE_EVERY_REQUEST = True  # reactivar el contador en cada interacción
...
WSGI_APPLICATION = 'elguaire.wsgi.application'
